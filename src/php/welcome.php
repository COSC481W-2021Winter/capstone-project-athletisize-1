	...
	<body>
		...
		<?php
				...
				if(getValue("soccer", $_SESSION['id'], $link) == 1){
					echo '<a href="soccer.php" class="btn btn-primary">Soccer</a>';
				}
				if(getValue("hockey", $_SESSION['id'], $link) == 1){
					echo '<a href="hockey.php" class="btn btn-primary">Hockey</a>';
				}
				if(getValue("ski", $_SESSION['id'], $link) == 1){
					echo '<a href="ski.php" class="btn btn-primary">Ski</a>';
				}
				if(getValue("snowboard", $_SESSION['id'], $link) == 1){
					echo '<a href="snowboard.php" class="btn btn-primary">Snowboard</a>';
				}
				if(getValue("baseball", $_SESSION['id'], $link) == 1){
					echo '<a href="baseball_softball.php" class="btn btn-primary">Baseball</a>';
				}
				if(getValue("lacrosse", $_SESSION['id'], $link) == 1){
					echo '<a href="lacrosse.php" class="btn btn-primary">Lacrosse</a>';
				}
